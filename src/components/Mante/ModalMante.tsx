...
const ModalMante = ({ children, estado, cambiarEstado, tituloModal = 'Reporte' }: { children: React.ReactNode, estado: any, cambiarEstado: any, tituloModal?: string }) => {
  return (
    <>
      {estado &&
